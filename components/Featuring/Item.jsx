...
const Item = ({ item, className, style }) => {
  return (
    <div className={`relative max-w-sm h-[70vh] border rounded-md overflow-hidden ${className} shadow-inner transition-all duration-300 hover:drop-shadow-xl drop-shadow-md bg-black`} style={style}>
